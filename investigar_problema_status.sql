-- Script para investigar o problema de status que persiste
-- Execute este script no SQL Editor do Supabase para diagnóstico detalhado

-- 1. Verificar se há algum trigger ou função que está interferindo
SELECT 
...
SELECT 
    'Funções relacionadas a clientes' as info,
    routine_name,
    routine_type,
    data_type
...
-- 3. Verificar se há alguma view que está interferindo
SELECT 
...
-- 4. Verificar se há alguma constraint que está alterando valores
SELECT 
...
-- 7. Verificar se há algum problema com a sequência do id_status
SELECT 
...
-- 8. Verificar se há algum problema com a tabela status_clientes
SELECT 
...
-- 9. Testar uma atualização manual para ver se há erro
-- Primeiro, pegar um cliente para teste
SELECT 
    'Cliente para teste' as info,
    id,
    nome_cliente,
    id_status
FROM clientes
...
-- 10. Verificar se há algum problema com RLS (Row Level Security)
SELECT 
...
-- 11. Verificar se há alguma política RLS ativa
SELECT 
...
-- 12. Verificar se há algum problema com o usuário atual
SELECT 
...
-- 13. Verificar se há algum problema com permissões
SELECT 
